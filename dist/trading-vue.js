/*!
 * TradingVue.JS - v1.0.2 - Thu Mar 25 2021
...
/* harmony default export */ const Legendvue_type_script_lang_js_ = ({
  ...
  computed: {
    ohlcv: function ohlcv() {
      ...
      return [this.$props.values.ohlcv[1].toFixed(2), this.$props.values.ohlcv[2].toFixed(2), this.$props.values.ohlcv[3].toFixed(2), this.$props.values.ohlcv[4].toFixed(2), this.$props.values.ohlcv[5] ? this.$props.values.ohlcv[5].toFixed(2) : 'n/a'];
    },
